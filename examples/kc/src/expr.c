/* Copyright 2023-2026 Kinglet B.V.
 *
...
#define xx(id, opt, load1_val, load2_val, load3_val, store_val) case id: op = opt; load[0] = load1_val; load[1] = load2_val; load[2] = load3_val; store = store_val; break;
    ...
    xx(ET_CVUC2US, nop, u8, none, none, u16)
    xx(ET_CVUS2UC, nop, u16, none, none, u8)
    ...
    xx(ET_LESS_THAN_ULLI, ult, ulli, ulli, none, si)
    xx(ET_LESS_THAN_ULI, ult, uli, uli, none, si)
    xx(ET_LESS_THAN_UI, ult, ui, ui, none, si)
    ...
    xx(ET_GREATER_THAN_ULLI, ugt, ulli, ulli, none, si)
    xx(ET_GREATER_THAN_ULI, ugt, uli, uli, none, si)
    xx(ET_GREATER_THAN_UI, ugt, ui, ui, none, si)
    ...
    xx(ET_LESS_THAN_OR_EQUAL_ULLI, ulte, ulli, ulli, none, si)
    xx(ET_LESS_THAN_OR_EQUAL_ULI, ulte, uli, uli, none, si)
    xx(ET_LESS_THAN_OR_EQUAL_UI, ulte, ui, ui, none, si)
    ...
    xx(ET_GREATER_THAN_OR_EQUAL_ULLI, ugte, ulli, ulli, none, si)
    xx(ET_GREATER_THAN_OR_EQUAL_ULI, ugte, uli, uli, none, si)
    xx(ET_GREATER_THAN_OR_EQUAL_UI, ugte, ui, ui, none, si)
